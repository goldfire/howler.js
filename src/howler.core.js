      ...
      if (self._webAudio) {
        ...
        var playWebAudio = function() {
          ...
          if (typeof node.bufferSource.start === 'undefined') {
            sound._loop ? node.bufferSource.noteGrainOn(0, seek, 31536000) : node.bufferSource.noteGrainOn(0, seek, duration);
          } else {
            sound._loop ? node.bufferSource.start(0, seek, 31536000) : node.bufferSource.start(0, seek, duration);
          }

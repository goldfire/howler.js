...
(function() {
  ...
  if (usingWebAudio) {
    ...
    /**
     * Get a 6 bits unsigned integer from a base64 character.
     * @param  {String} it A base64 encoded data.
     */
    var uint6FromBase64 = function(it){
      if (!it.charCodeAt) {
    ...
    /**
     * Get a base64 character from a 6 bits unsigned integer.
     * @param  {Number} it The 6 bits long integer.
     */
    var base64FromUint6 = function(it){
      switch (false) {
      case !(0 <= it && it < 26):
    ...
    /**
     * Get an array of bytes from base64 string.
     * @param  {String} it A base64 string.
     */
    var arrayFromBase64 = function(it){
    ...
    /**
     * Create a base64 string from an array of bytes.
     * @param  {Array} it The byte array.
     */
    var base64FromArray = function(it){
      var result, padding, c, v, x$;
      result = [];
      while (it.length) {
        padding = 0;

...
* **on**: Call/set custom events. Multiple events can be added by calling this multiple times.
  ...
  * *context*: `Object` (optional) Sets the context in which the function is executed.
* **off**: Remove custom events that you've set.
  * *event*: `String` Name of event.
  * *function*: `Function` (optional) The listener to remove.
  * *context*: `Object` (optional) Limits removal of the listener to the specific context.
...
Code coverage is also produced, and contained in ./coverage, it is generated by default.
